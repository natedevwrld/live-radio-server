...
export declare type Extension = (...args: TodoAny) => InjectableDeclaration[];
export declare type ExtensionMap = Record<string, Extension>;
export declare type ModuleConfig<E extends ExtensionMap> = {
    name: string;
    providers: InjectableDeclaration[];
    imports?: ModuleDeclaration[];
    extend?: E;
};
export declare type ModuleDeclaration<E extends ExtensionMap = {}> = {
    /**
     * @internal
     */
