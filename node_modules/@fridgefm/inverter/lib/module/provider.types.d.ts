...
export declare type ProviderConfig<T extends Token<unknown> = Token<unknown>, DepToks extends TokenDecTuple = TokenDecTuple> = ({
    provide: T;
} & ({
 ...
 */
export declare type InjectableDeclaration<T extends Token<unknown> = Token<unknown>, DepToks extends TokenDecTuple = TokenDecTuple> = ProviderConfig<Token<T>, DepToks> & {
    /**
