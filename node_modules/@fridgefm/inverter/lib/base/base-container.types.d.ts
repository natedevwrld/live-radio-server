...
/** @internal */
export declare type FactoryContext<T> = {
    factory: (container: Container) => T;
    options?: FactoryOptions;
};
export declare type MultiRecord<T> = {
    factory: (container: Container) => T;
...
/** @internal */
export declare type ValuesMap = Map<symbol, TodoAny>;
/** @internal */
export declare type FactoriesMap = Map<symbol, FactoryContext<TodoAny>>;
/** @internal */
export declare type MultiesMap = Map<symbol, MultiRecord<TodoAny>[]>;
/** @internal */
export declare type Resolver = <T>(token: Token<T>, origin: Container) => T | typeof NOT_FOUND_SYMBOL;
